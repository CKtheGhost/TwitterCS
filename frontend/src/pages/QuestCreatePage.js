...
const QuestCreatePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // await questService.createQuest(formState);
  ...
  if (!isConnected) {
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="card">
          <h3 className="mb-4">Create New Quest</h3>
        ...
        <div className="bg-green-50 border border-green-200 rounded-md p-4 mb-6">
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <p className="text-sm text-green-700 mt-1">Quest has been created successfully!</p>
            </div>
          </div>
        </div>
      )}
